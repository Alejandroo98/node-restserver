...
app.post( '/login', function( req , res ){
    ...
    User.findOne( { email : body.email } , ( err , userDB ) =>{
        ...
        } , process.env.SEED , { expiresIn : '48h' } ) // process.env.SEED es la firma del token y esto es como una clave del token - luego viene la fecha de expiracion que eneste caso esta en un mes , primer son los segudos luego los minutos las horas los dias los meses etc, y que su valor se encuentra en el archivo llamado config.js
